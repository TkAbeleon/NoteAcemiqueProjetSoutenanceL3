# 📘 Glossaire des Tags — JeryMotro Platform
#JeryMotro #Reference #Soutenance
[[00_INDEX]]

> Centralise tous les tags du vault. Tout nouveau tag → l'ajouter ici.
...
|-----------|-----|-------------|
| **Projet** | `#JeryMotro` | Toutes les notes du projet |
| **Projet** | `#MemoireL3` | Mémoire Licence 3 Génie Logiciel |
| **Avancement** | `#Avancement` | Suivi progression |
| **Avancement** | `#DailyNote` | Note quotidienne |
| **Avancement** | `#Milestone` | Jalon important |
| **Problèmes** | `#Problem` | Problème / limite |
...
| **Sources** | `#FIRMS` | FIRMS API |
| **Sources** | `#MODIS` | Capteur MODIS |
| **Sources** | `#VIIRS` | Capteur VIIRS |
| **Variables** | `#FRP` | Fire Radiative Power |
...
## Règles
- ➕ Nouveau tag → l'ajouter ici avant de l'utiliser
- ✅ Toujours : `#JeryMotro` + tag domaine
- ❌ Pas de doublons (`#Datasets` ≠ `#Dataset`)
